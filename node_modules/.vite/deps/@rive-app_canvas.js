		...
		return (() => {
			...
			var __webpack_modules__ = [
				...
				((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
					...
					const __WEBPACK_DEFAULT_EXPORT__ = (() => {
						...
						return async function(moduleArg = {}) {
							var moduleRtn;
							var k = moduleArg, ca = !!globalThis.window, da = !!globalThis.WorkerGlobalScope;
							function ea() {
								function a(g) {
									const h = d;
									c = b = 0;
								...
								this.Mc = function(g) {
									...
									e = new function() {
										...
										this.Oc = function() {
											...
											m ? (++h, l -= m, 1e3 < l && (g(1e3 * h / l), h = m = 0)) : (m = l, h = 0);
										};
									}();
								};
								this.Jc = function() {
							...
							const ia = "createConicGradient createImageData createLinearGradient createPattern createRadialGradient getContextAttributes getImageData getLineDash getTransform isContextLost isPointInPath isPointInStroke measureText".split(" "), ja = new function() {
								function a() {
									if (!b) {
										var w = document.createElement("canvas"), x = {
											alpha: 1,
											depth: 0,
											stencil: 0,
											antialias: 0,
										...
										if (/iPhone|iPad|iPod/i.test(navigator.userAgent)) {
											if (p = w.getContext("webgl", x), c = 1, !p) return console.log("No WebGL support. Image mesh will not be drawn."), !1;
										...
										p = new Proxy(p, {
											get(F, q) {
												if (F.isContextLost()) {
													if (m || (console.error("Cannot render the mesh because the GL Context was lost. Tried to invoke ", q), m = !0), "function" === typeof F[q]) return function() {};
												} else return "function" === typeof F[q] ? function(...K) {
													return F[q].apply(F, K);
												} : F[q];
											},
											set(F, q, K) {
												if (F.isContextLost()) m || (console.error("Cannot render the mesh because the GL Context was lost. Tried to set property " + q), m = !0);
												else return F[q] = K, !0;
											}
										});
										...
										w = p.createProgram();
										H(w, p.VERTEX_SHADER, "attribute vec2 vertex;\n                attribute vec2 uv;\n                uniform vec4 mat;\n                uniform vec2 translate;\n                varying vec2 st;\n                void main() {\n                    st = uv;\n                    gl_Position = vec4(mat2(mat) * vertex + translate, 0, 1);\n                }");
								...
								let b = null, c = 0, d = 0, e = null, f = null, g = 0, h = 0, m = !1;
								a();
								this.ad = function() {
									a();
									return d;
								...
								this.Hc = function(w) {
									...
									b.texImage2D(b.TEXTURE_2D, 0, b.RGBA, b.RGBA, b.UNSIGNED_BYTE, w);
								...
								const l = new fa(8), u = new fa(8), y = new fa(10), t = new fa(10);
								this.Lc = function(w, x, p, H, F) {
									if (a()) {
										var q = l.push(w), K = u.push(x);
										if (b.canvas) {
											if (b.canvas.width != q || b.canvas.height != K) b.canvas.width = q, b.canvas.height = K;
											...
											q = y.push(H);
											g != q && (b.bufferData(b.ARRAY_BUFFER, 8 * q, b.DYNAMIC_DRAW), g = q);
											q = 0;
											for (var O of p) b.bufferSubData(b.ARRAY_BUFFER, q, O.Tb), q += 4 * O.Tb.length;
											console.assert(q == 4 * H);
											for (var S of p) b.bufferSubData(b.ARRAY_BUFFER, q, S.xc), q += 4 * S.xc.length;
											console.assert(q == 8 * H);
											q = t.push(F);
											h != q && (b.bufferData(b.ELEMENT_ARRAY_BUFFER, 2 * q, b.DYNAMIC_DRAW), h = q);
											O = 0;
											for (var na of p) b.bufferSubData(b.ELEMENT_ARRAY_BUFFER, O, na.indices), O += 2 * na.indices.length;
											console.assert(O == 2 * F);
											na = 0;
											S = !0;
											q = O = 0;
											for (const I of p) {
												I.image.Ib != na && (b.bindTexture(b.TEXTURE_2D, I.image.Hb || null), na = I.image.Ib);
												I.ed ? (b.scissor(I.Yb, K - I.Zb - I.fc, I.od, I.fc), S = !0) : S && (b.scissor(0, K - x, w, x), S = !1);
												p = 2 / w;
												const Z = -2 / x;
												b.uniform4f(e, I.ib[0] * p * I.Ab, I.ib[1] * Z * I.Bb, I.ib[2] * p * I.Ab, I.ib[3] * Z * I.Bb);
												b.uniform2f(f, I.ib[4] * p * I.Ab + p * (I.Yb - I.bd * I.Ab) - 1, I.ib[5] * Z * I.Bb + Z * (I.Zb - I.cd * I.Bb) + 1);
												b.vertexAttribPointer(0, 2, b.FLOAT, !1, 0, q);
												b.vertexAttribPointer(1, 2, b.FLOAT, !1, 0, q + 4 * H);
												b.drawElements(b.TRIANGLES, I.indices.length, b.UNSIGNED_SHORT, O);
												q += 4 * I.Tb.length;
							...
							k.onRuntimeInitialized = function() {
								function a(n) {
									switch (n) {
										case l.srcOver: return "source-over";
										case l.screen: return "screen";
										case l.overlay: return "overlay";
										case l.darken: return "darken";
										case l.lighten: return "lighten";
										case l.colorDodge: return "color-dodge";
										case l.colorBurn: return "color-burn";
										case l.hardLight: return "hard-light";
										case l.softLight: return "soft-light";
										case l.difference: return "difference";
										case l.exclusion: return "exclusion";
										case l.multiply: return "multiply";
										case l.hue: return "hue";
										case l.saturation: return "saturation";
										case l.color: return "color";
										case l.luminosity: return "luminosity";
									}
								}
								function b(n) {
								...
								function c() {
									0 < K.length && (ja.Lc(q.drawWidth(), q.drawHeight(), K, O, S), K = [], S = O = 0, q.reset(512, 512));
									for (const n of F) {
								...
								const e = k.RenderPath, f = k.RenderPaint, g = k.Renderer, h = k.StrokeCap, m = k.StrokeJoin, l = k.BlendMode, u = d.fill, y = d.stroke, t = k.FillRule.evenOdd;
								let w = 1;
								var x = k.RenderImage.extend("CanvasRenderImage", {
									...
									decode: function(n) {
										...
										r.yb && r.yb(r);
										var G = new Image();
										r.Wb = URL.createObjectURL(new Blob([n], { type: "image/png" }));
										G.onload = function() {
											r.Ac = G;
											r.Hb = ja.Hc(G);
									...
									draw: function(n, r, G, D) {
										let z = this.Dc;
										var E = this.Xb, C = this.lb;
										const L = n.globalCompositeOperation, ua = n.globalAlpha;
										n.globalCompositeOperation = this.zc;
										n.globalAlpha = D;
										if (null != C) {
											E = C.uc;
											const V = C.vc, ba = C.bc;
											var R = C.cc;
											D = C.Sb;
											C.Zc ? (C = ba - E, R -= V, E = n.createRadialGradient(E, V, 0, E, V, Math.sqrt(C * C + R * R))) : E = n.createLinearGradient(E, V, ba, R);
											for (let W = 0, aa = D.length; W < aa; W++) C = D[W], E.addColorStop(C.stop, b(C.color));
											this.Xb = E;
											this.lb = null;
										}
										switch (z) {
											case y:
												...
												n.stroke(r);
												break;
											case u: n.fillStyle = E, n.fill(r, G);
										}
								...
								var na = k.CanvasRenderer = g.extend("Renderer", {
									...
									transform: function(n, r, G, D, z, E) {
										const C = this.Xa, L = C.length - 6;
										C.splice(L, 6, C[L] * n + C[L + 2] * r, C[L + 1] * n + C[L + 3] * r, C[L] * G + C[L + 2] * D, C[L + 1] * G + C[L + 3] * D, C[L] * z + C[L + 2] * E + C[L + 4], C[L + 1] * z + C[L + 3] * E + C[L + 5]);
										this.Na.push(this.Ha.transform.bind(this.Ha, n, r, G, D, z, E));
									},
									rotate: function(n) {
										const r = Math.sin(n);
										n = Math.cos(n);
									...
									_drawPath: function(n, r) {
										this.Na.push(r.draw.bind(r, this.Ha, n.Ya, n.Vb === t ? "evenodd" : "nonzero", Math.max(0, this.Ka[this.Ka.length - 1])));
									},
									_drawRiveImage: function(n, r, G, D) {
										var z = n.Ac;
										if (z) {
											var E = this.Ha, C = a(G), L = Math.max(0, D * this.Ka[this.Ka.length - 1]);
									...
									_getMatrix: function(n) {
										const r = this.Xa, G = r.length - 6;
										for (let D = 0; 6 > D; ++D) n[D] = r[G + D];
									},
									_drawImageMesh: function(n, r, G, D, z, E, C, L, ua, R, V, ba, W, aa) {
										let Qb, Rb, Sb;
										try {
											Qb = k.HEAPF32.slice(z >> 2, (z >> 2) + E), Rb = k.HEAPF32.slice(C >> 2, (C >> 2) + L), Sb = k.HEAPU16.slice(ua >> 1, (ua >> 1) + R);
										} catch (hb) {
										...
										W = Math.min(W, r);
										aa = Math.min(aa, z);
										const Da = W - V, Ea = aa - ba;
										console.assert(Da <= Math.min(C, r));
										console.assert(Ea <= Math.min(L, z));
										if (!(0 >= Da || 0 >= Ea)) {
											W = Da < C || Ea < L;
											r = aa = 1;
											var oa = Math.ceil(Da * aa), pa = Math.ceil(Ea * r);
											z = ja.ad();
											oa > z && (aa *= z / oa, oa = z);
											pa > z && (r *= z / pa, pa = z);
											q || (q = new k.DynamicRectanizer(z), q.reset(512, 512));
											z = q.addRect(oa, pa);
											0 > z && (c(), F.add(this), z = q.addRect(oa, pa), console.assert(0 <= z));
											var Tb = z & 65535, Ub = z >> 16;
											K.push({
											...
											O += E;
											S += R;
											var va = this.Ha, Vc = a(G), Wc = Math.max(0, D * this.Ka[this.Ka.length - 1]);
											this.Na.push(function() {
												va.save();
												va.resetTransform();
									...
									_clipPath: function(n) {
										this.Na.push(this.Ha.clip.bind(this.Ha, n.Ya, n.Vb === t ? "evenodd" : "nonzero"));
									},
									clear: function() {
										F.add(this);
										this.Na.push(this.Ha.clearRect.bind(this.Ha, 0, 0, this.Ub.width, this.Ub.height));
									},
									flush: function() {},
									...
									return new Proxy(r, {
										get(D, z) {
											...
											if ("function" === typeof G[z]) {
												if (-1 < ia.indexOf(z)) throw Error("RiveException: Method call to '" + z + "()' is not allowed, as the renderer cannot immediately pass through the return                 values of any canvas 2d context methods.");
												return function(...E) {
							...
							if (ca || da) {
								...
								qa = async (a) => {
									if (sa(a)) return new Promise((c, d) => {
							...
							var ta = console.log.bind(console), wa = console.error.bind(console), xa, ya = !1, za, sa = (a) => a.startsWith("file://"), Aa, Ba, v, A, Ca, Fa, B, J, Ga, Ha, Ia, Ja, Ka = !1;
							function La() {
								var a = Ma.buffer;
							...
							async function Ra(a) {
								...
								if (!xa && !sa(b)) try {
									...
									wa(`wasm streaming compile failed: ${d}`), wa("falling back to ArrayBuffer instantiation");
								}
								return Qa(b, a);
							}
							class Sa {
							...
							var Ta = (a) => {
								...
								b &&= b.slice(0, -1);
								return a + b;
							}, cb = () => (a) => crypto.getRandomValues(a), db = (a) => {
								(db = cb())(a);
							}, eb = (...a) => {
								...
								b = $a(b.split("/").filter((e) => !!e), !c).join("/");
								return (c ? "/" : "") + b || ".";
							}, fb = globalThis.TextDecoder && new TextDecoder(), gb = (a, b, c, d) => {
								c = b + c;
								if (d) return c;
								for (; a[b] && !(b >= c);) ++b;
								return b;
							...
							var pb = {
								...
								Pb(a, b) {
									null === b || 10 === b ? (ta(ib(a.output)), a.output = []) : 0 != b && a.output.push(b);
								},
								sb(a) {
								...
								Pb(a, b) {
									null === b || 10 === b ? (wa(ib(a.output)), a.output = []) : 0 != b && a.output.push(b);
								},
								sb(a) {
								...
								createNode(a, b, c, d) {
									...
									c = tb(a, b, c, d);
									16384 === (c.mode & 61440) ? (c.za = N.Ua.dir.node, c.xa = N.Ua.dir.stream, c.ya = {}) : 32768 === (c.mode & 61440) ? (c.za = N.Ua.file.node, c.xa = N.Ua.file.stream, c.Ga = 0, c.ya = null) : 40960 === (c.mode & 61440) ? (c.za = N.Ua.link.node, c.xa = N.Ua.link.stream) : 8192 === (c.mode & 61440) && (c.za = N.Ua.$b.node, c.xa = N.Ua.$b.stream);
									c.gb = c.Ra = c.Oa = Date.now();
									a && (a.ya[b] = c, a.gb = a.Ra = a.Oa = c.gb);
									return c;
								},
								Dd(a) {
									return a.ya ? a.ya.subarray ? a.ya.subarray(0, a.Ga) : new Uint8Array(a.ya) : /* @__PURE__ */ new Uint8Array(0);
								},
								za: {
									eb(a) {
										var b = {};
									...
									nb() {
										N.Jb || (N.Jb = new M(44), N.Jb.stack = "<generic error, no stack>");
										throw N.Jb;
									},
									wb(a, b, c, d) {
									...
									qc(a, b, c) {
										...
										if (d) {
											if (16384 === (a.mode & 61440)) for (var e in d.ya) throw new M(55);
								...
								b && (c |= 146);
								return c;
							}, yb = null, zb = {}, Ab = [], Bb = 1, wb = null, Cb = !1, Db = !0, Eb = {}, M = class {
								name = "ErrnoError";
								constructor(a) {
									this.bb = a;
								}
							...
							function Hb(a, b = {}) {
								...
								a: for (; 40 > c; c++) {
									...
									for (var d = yb, e = "/", f = 0; f < a.length; f++) {
										var g = f === a.length - 1;
										if (g && b.parent) break;
										if ("." !== a[f]) if (".." === a[f]) if (e = bb(e), d === d.parent) {
							...
							function ub(a, b) {
								var c = 16384 === (a.mode & 61440) ? (c = Ib(a, "x")) ? c : a.za.nb ? 0 : 2 : 54;
								if (c) throw new M(c);
							...
							function Zb(a, b, c = 438) {
								...
								if (!f && (e = d ? 40960 === (d.mode & 61440) ? 32 : 16384 === (d.mode & 61440) && ("r" !== Jb(b) || b & 576) ? 31 : Ib(d, Jb(b)) : 44)) throw new M(e);
								if (b & 512 && !f) {
									e = d;
								...
								f && (c &= 511, d = "string" == typeof d ? Hb(d, { Kb: !0 }).node : d, Ob(d, {
							...
							var bc = {}, Ya = void 0, cc = (a, b) => Object.defineProperty(b, "name", { value: a }), dc = [], ec = [
								0,
								1,
								,
								1,
							...
							var T = (a) => {
								...
								var c = jc[a];
								if (void 0 === c) throw a = `${b} has unknown type ${mc(a)}`, new P(a);
								return c;
							}, oc = () => {}, pc = !1, qc = (a) => {
								...
								pc = new FinalizationRegistry((b) => {
									b = b.va;
									--b.count.value;
									0 === b.count.value && (b.Ja ? b.Pa.Va(b.Ja) : b.Da.wa.Va(b.Ba));
								});
								qc = (b) => {
									var c = b.va;
							...
							var uc = {}, vc = {}, wc = class extends Error {
								...
								for (let [h, m] of b.entries()) jc.hasOwnProperty(m) ? e[h] = jc[m] : (f.push(m), uc.hasOwnProperty(m) || (uc[m] = []), uc[m].push(() => {
									e[h] = jc[m];
									++g;
									g === f.length && d(e);
								}));
							...
							var yc = (a, b, c) => {
								switch (b) {
									case 1: return c ? (d) => v[d] : (d) => A[d];
									case 2: return c ? (d) => Ca[d >> 1] : (d) => Fa[d >> 1];
									case 4: return c ? (d) => B[d >> 2] : (d) => J[d >> 2];
									case 8: return c ? (d) => Ia[d >> 3] : (d) => Ja[d >> 3];
							...
							var Cc = {}, Dc = (a, b, c) => {
								if (void 0 === a[b].Fa) {
									var d = a[b];
									a[b] = function(...e) {
										if (!a[b].Fa.hasOwnProperty(e.length)) throw new P(`Function '${c}' called with an invalid number of arguments (${e.length}) - expects one of (${a[b].Fa})!`);
								...
								if (k.hasOwnProperty(a)) {
									if (void 0 === c || void 0 !== k[a].Fa && void 0 !== k[a].Fa[c]) throw new P(`Cannot register public name '${a}' twice`);
									Dc(k, a, a);
									if (k[a].Fa.hasOwnProperty(c)) throw new P(`Cannot register multiple overloads of a function with the same number of arguments (${c})!`);
									k[a].Fa[c] = b;
								} else k[a] = b, k[a].Za = c;
							}, Fc = (a) => {
							...
							var Hc = (a, b, c) => {
								for (; b !== c;) {
									if (!b.qb) throw new P(`Expected null or instance of ${c.name}, got an instance of ${b.name}`);
									a = b.qb(a);
									b = b.Ia;
								}
								return a;
							...
							function Jc(a, b) {
								...
								if (!b.va) throw new P(`Cannot pass "${Ic(b)}" as a ${this.name}`);
								if (!b.va.Ba) throw new P(`Cannot pass deleted object as a pointer of type ${this.name}`);
							...
							function Kc(a, b) {
								...
								if (!b || !b.va) throw new P(`Cannot pass "${Ic(b)}" as a ${this.name}`);
								if (!b.va.Ba) throw new P(`Cannot pass deleted object as a pointer of type ${this.name}`);
								if (!this.ub && b.va.Da.ub) throw new P(`Cannot convert argument of type ${b.va.Pa ? b.va.Pa.name : b.va.Da.name} to parameter type ${this.name}`);
								c = Hc(b.va.Ba, b.va.Da.wa, this.wa);
								if (this.vb) {
									if (void 0 === b.va.Ja) throw new P("Passing raw pointer to smart pointer is illegal");
									switch (this.md) {
										case 0:
											if (b.va.Pa === this) c = b.va.Ja;
											else throw new P(`Cannot convert argument of type ${b.va.Pa ? b.va.Pa.name : b.va.Da.name} to parameter type ${this.name}`);
											break;
										case 1:
											c = b.va.Ja;
											break;
										case 2:
											if (b.va.Pa === this) c = b.va.Ja;
												...
												var d = b.clone();
												c = this.hd(c, fc(() => d["delete"]()));
												null !== a && a.push(this.Va, c);
											}
											break;
										default: throw new P("Unsupported sharing policy");
									}
								}
								return c;
							}
							function Lc(a, b) {
								...
								if (!b.va) throw new P(`Cannot pass "${Ic(b)}" as a ${this.name}`);
								if (!b.va.Ba) throw new P(`Cannot pass deleted object as a pointer of type ${this.name}`);
								if (b.va.Da.ub) throw new P(`Cannot convert argument of type ${b.va.Da.name} to parameter type ${this.name}`);
								return Hc(b.va.Ba, b.va.Da.wa, this.wa);
							}
							var Mc = (a, b, c) => {
								if (b === c) return a;
								...
								if (!!b.Pa !== !!b.Ja) throw new wc("Both smartPtrType and smartPtr must be specified");
								b.count = { value: 1 };
							...
							function Pc(a, b, c, d, e, f, g, h, m, l, u) {
								...
								this.hd = l;
								this.Va = u;
								e || void 0 !== b.Ia ? this.Ea = Kc : (this.Ea = d ? Jc : Lc, this.La = null);
							}
							var Qc = (a, b, c) => {
								if (!k.hasOwnProperty(a)) throw new wc("Replacing nonexistent public symbol");
								void 0 !== k[a].Fa && void 0 !== c ? k[a].Fa[c] = b : (k[a] = b, k[a].Za = c);
							}, Y = (a, b) => {
								a = T(a);
								var c = Rc.get(b);
							...
							function Yc(a, b, c, d, e) {
								...
								var g = null !== b[1] && null !== c, h = Uc(b), m = !b[0].$c, l = f - 2, u = Array(l), y = [], t = [];
								return cc(a, function(...w) {
									...
									for (var p = 0; p < l; ++p) u[p] = b[p + 2].Ea(t, w[p]), y.push(u[p]);
									w = d(...y);
									if (h) sc(t);
							...
							var Zc = (a, b) => {
								...
								if (!(a instanceof b.wa.constructor)) throw new P(`${c} incompatible with "this" of type ${a.constructor.name}`);
								if (!a.va.Ba) throw new P(`cannot call emscripten binding method ${c} on deleted object`);
								...
								for (var e = 0; e < c; ++e) Ca[b >> 1] = a.charCodeAt(e), b += 2;
								Ca[b >> 1] = 0;
								return b - d;
								...
								for (var c = Array(a), d = 0; d < a; ++d) c[d] = nc(J[b + 4 * d >> 2], `parameter ${d}`);
								return c;
							}, rd = {}, sd = (a) => {
								var b = rd[a];
							...
							(() => {
								...
								Object.assign(a, {
									...
									["delete"]() {
										this.va.Ba || zc(this);
										if (this.va.mb && !this.va.kb) throw new P("Object already scheduled for deletion");
										oc(this);
										var c = this.va;
										--c.count.value;
										0 === c.count.value && (c.Ja ? c.Pa.Va(c.Ja) : c.Da.wa.Va(c.Ba));
							...
							Object.assign(Pc.prototype, {
								...
								Aa: function(a) {
									...
									return null === e ? b.call(this) : this.vb ? Oc(d.wa.Sa, {
										Da: d,
										Ba: e,
										Pa: this,
										Ja: a
							...
							var Gd = {
									...
									if ("undefined" === typeof window.miniaudio) {
										...
										f.unlock = function() {
											for (var g = 0; g < f.devices.length; ++g) {
												var h = f.devices[g];
												null != h && null != h.Qa && h.state === f.device_state.started && h.Qa.resume().then(() => {
													Dd(h.nc);
												}, (m) => {
								...
								239393: () => void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia,
								239497: () => {
									try {
								...
								239668: (a, b, c, d, e, f) => {
									...
									g.Qa = new (window.AudioContext || window.webkitAudioContext)(h);
									g.Qa.suspend();
									...
									g.fb.onaudioprocess = function(m) {
										if (null == g.tb || 0 == g.tb.length) g.tb = new Float32Array(Ga.buffer, e, d * b);
										if (a == window.miniaudio.device_type.capture || a == window.miniaudio.device_type.duplex) {
											for (var l = 0; l < b; l += 1) for (var u = m.inputBuffer.getChannelData(l), y = g.tb, t = 0; t < d; t += 1) y[t * b + l] = u[t];
											Ed(f, d, e);
										}
										if (a == window.miniaudio.device_type.playback || a == window.miniaudio.device_type.duplex) for (Fd(f, d, e), l = 0; l < m.outputBuffer.numberOfChannels; ++l) for (u = m.outputBuffer.getChannelData(l), y = g.tb, t = 0; t < d; t += 1) u[t] = y[t * b + l];
										else for (l = 0; l < m.outputBuffer.numberOfChannels; ++l) m.outputBuffer.getChannelData(l).fill(0);
									};
									...
									a == window.miniaudio.device_type.playback && g.fb.connect(g.Qa.destination);
									g.nc = f;
									return window.miniaudio.track_device(g);
								},
								242545: (a) => window.miniaudio.get_device_by_index(a).Qa.sampleRate,
								242618: (a) => {
									a = window.miniaudio.get_device_by_index(a);
									void 0 !== a.fb && (a.fb.onaudioprocess = function() {}, a.fb.disconnect(), a.fb = void 0);
							...
							}, lc, Hd, kc, Dd, Ed, Fd, Id, Jd, Kd, Ld, Ma, Rc, Nd = {
								s: function(a, b, c) {
									Ya = c;
									try {
										var d = Lb(a);
										switch (b) {
											...
											case 4: return e = Za(), d.flags |= e, 0;
											case 12: return e = Za(), Ca[e + 0 >> 1] = 2, 0;
											case 13:
											case 14: return 0;
										}
										return -28;
									} catch (f) {
										if ("undefined" == typeof bc || "ErrnoError" !== f.name) throw f;
										return -f.bb;
									}
								},
								L: function(a, b, c) {
									...
									try {
										...
										switch (b) {
											...
											case 21508:
												if (!d.Ca) return -59;
												if (d.Ca.ab.Xc) for (e = Za(), a = [], f = 0; 32 > f; f++) a.push(v[e + f + 17]);
												return 0;
											case 21519:
												if (!d.Ca) return -59;
												e = Za();
											...
											case 21523:
												if (!d.Ca) return -59;
												d.Ca.ab.Yc && (f = [24, 80], e = Za(), Ca[e >> 1] = f[0], Ca[e + 2 >> 1] = f[1]);
												return 0;
										...
										if ("undefined" == typeof bc || "ErrnoError" !== g.name) throw g;
										return -g.bb;
									}
								},
								M: function(a, b, c, d) {
									...
									try {
										...
										if ("undefined" == typeof bc || "ErrnoError" !== h.name) throw h;
										return -h.bb;
									}
								},
								P: () => Na(""),
								o: (a, b, c) => {
									...
									b = nc(b, "wrapper");
									c = Q(c);
									var d = b.wa, e = d.Sa, f = d.Ia.Sa, g = d.Ia.constructor;
									a = cc(a, function(...h) {
										for (var m of d.Ia.oc) if (this[m] === f[m]) throw new gc(`Pure virtual function ${m} must be implemented in JavaScript`);
										Object.defineProperty(this, "__parent", { value: e });
										this.__construct(...h);
									});
									e.__construct = function(...h) {
										if (this === e) throw new P("Pass correct 'this' to __construct");
										...
										h = m.Ba;
										h = ic(d, h);
										if (hc.hasOwnProperty(h)) throw new P(`Tried to register registered instance: ${h}`);
										hc[h] = this;
									};
									e.__destruct = function() {
										if (this === e) throw new P("Pass correct 'this' to __destruct");
										oc(this);
										var h = this.va.Ba;
										h = ic(d, h);
										if (hc.hasOwnProperty(h)) delete hc[h];
										else throw new P(`Tried to unregister unregistered instance: ${h}`);
									};
								...
								_: (a) => {
									var b = rc[a];
									delete rc[a];
									var c = b.Qb, d = b.Va, e = b.dc, f = e.map((g) => g.Tc).concat(e.map((g) => g.kd));
									X([a], f, (g) => {
										var h = {}, m, l;
										for ([m, l] of e.entries()) {
											const u = g[m], y = l.Rc, t = l.Sc, w = g[m + e.length], x = l.jd, p = l.ld;
											h[l.Nc] = {
												read: (H) => u.Aa(y(t, H)),
												write: (H, F) => {
													var q = [];
										...
										return [{
											...
											Ea: (u, y) => {
												for (var t in h) if (!(t in y || h[t].optional)) throw new TypeError(`Missing field: "${t}"`);
												var w = c();
								...
								c: (a, b, c, d, e, f, g, h, m, l, u, y, t) => {
									...
									X([
										...
										x = cc(u, function(...O) {
											if (Object.getPrototypeOf(this) !== F) throw new P(`Use 'new' to construct ${u}`);
											if (void 0 === q.hb) throw new P(`${u} has no accessible constructor`);
											var S = q.hb[O.length];
											if (void 0 === S) throw new P(`Tried to invoke ctor of ${u} with invalid number of parameters (${O.length}) - expected (${Object.keys(q.hb).toString()}) parameters instead!`);
								...
								k: (a, b, c, d, e, f, g) => {
									...
									X([], [a], (m) => {
										...
										void 0 === y[b] ? (l.Za = c - 1, y[b] = l) : (Dc(y, b, u), y[b].Fa[c - 1] = l);
										X([], h, (t) => {
											t = Yc(u, [t[0], null].concat(t.slice(1)), null, f, g);
											void 0 === y[b].Fa ? (t.Za = c - 1, y[b] = t) : y[b].Fa[c - 1] = t;
											if (m.wa.rb) for (const w of m.wa.rb) w.constructor.hasOwnProperty(b) || (w.constructor[b] = t);
											return [];
										});
										return [];
									});
								...
								n: (a, b, c, d, e, f) => {
									...
									X([], [a], (h) => {
										...
										if (void 0 !== h.wa.hb[b - 1]) throw new P(`Cannot register multiple constructors with identical number of parameters (${b - 1}) for class '${h.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
										h.wa.hb[b - 1] = () => {
								...
								a: (a, b, c, d, e, f, g, h) => {
									...
									X([], [a], (l) => {
										...
										h && l.wa.oc.push(b);
										var t = l.wa.Sa, w = t[b];
										void 0 === w || void 0 === w.Fa && w.className !== l.name && w.Za === c - 2 ? (u.Za = c - 2, u.className = l.name, t[b] = u) : (Dc(t, b, y), t[b].Fa[c - 2] = u);
										X([], m, (x) => {
											x = Yc(y, x, l, f, g);
											void 0 === t[b].Fa ? (x.Za = c - 2, t[b] = x) : t[b].Fa[c - 2] = x;
											return [];
										});
										return [];
									});
								...
								b: (a, b, c, d, e, f, g, h, m, l) => {
									...
									X([], [a], (u) => {
										...
										t.set = m ? () => Tc(`Cannot access ${y} due to unbound types`, [c, g]) : () => {
									...
									switch (d.valueType) {
										case "object":
											...
											d = Object.create(d.constructor.prototype, {
												value: { value: c },
												constructor: { value: cc(`${d.name}_${b}`, function() {}) }
											});
											a.values[c] = d;
											a[b] = d;
											break;
										case "number":
											d.Ob[b] = c;
											break;
										case "string": d.yc[b] = c, d.rc[c] = b, d.Ob[b] = b;
									}
								},
								t: (a, b, c) => {
									b = T(b);
								...
								i: (a, b, c, d, e, f) => {
									...
									X([], g, (h) => {
										Qc(a, Yc(a, [h[0], null].concat(h.slice(1)), null, e, f), b - 1);
										return [];
									});
								},
								l: (a, b, c, d, e) => {
								...
								f: (a, b, c) => {
									var [d, ...e] = qd(a, b), f = d.Ea.bind(d), g = e.map((m) => m.Ma.bind(m));
									a--;
									var h = Array(a);
									b = `methodCaller<(${e.map((m) => m.name)}) => ${d.name}>`;
									return pd(cc(b, (m, l, u, y) => {
										for (var t = 0, w = 0; w < a; ++w) h[w] = g[w](y + t), t += 8;
										switch (c) {
											case 0:
								...
								G: function(a, b) {
									...
									B[b + 24 >> 2] = a.getDay();
									var c = a.getFullYear();
									B[b + 28 >> 2] = (0 !== c % 4 || 0 === c % 100 && 0 !== c % 400 ? ud : td)[a.getMonth()] + a.getDate() - 1 | 0;
								...
								H: (a, b, c, d) => {
									...
									a = b(f);
									b = b(e);
									e < f ? (lb(a, A, c, 17), lb(b, A, d, 17)) : (lb(a, A, d, 17), lb(b, A, c, 17));
								},
								O: function(a, b, c) {
									if (!(0 <= a && 3 >= a)) return 28;
									Ia[c >> 3] = BigInt(Math.round(1e6 * (0 === a ? Date.now() : performance.now())));
									return 0;
								},
								j: (a, b, c) => {
									zd.length = 0;
									for (var d; d = A[b++];) {
										...
										e &= 112 != d;
										c += e && c % 8 ? 4 : 0;
										zd.push(112 == d ? J[c >> 2] : 106 == d ? Ia[c >> 3] : 105 == d ? B[c >> 2] : Ha[c >> 3]);
										c += e ? 8 : 4;
									}
									return Gd[a](...zd);
								},
								...
								r: function(a) {
									try {
										...
										if ("undefined" == typeof bc || "ErrnoError" !== c.name) throw c;
										return c.bb;
									}
								},
								K: function(a, b, c, d) {
									try {
										a: {
											...
											for (var f, g = b = 0; g < c; g++) {
												var h = J[a >> 2], m = J[a + 4 >> 2];
												a += 8;
												var l = e, u = h, y = m, t = f, w = v;
										...
										if ("undefined" == typeof bc || "ErrnoError" !== q.name) throw q;
										return q.bb;
									}
								},
								I: function(a, b, c, d) {
							...
							var Od = await async function() {
								...
								Oa ??= k.locateFile ? k.locateFile("canvas_advanced.wasm", ma) : ma + "canvas_advanced.wasm";
							...
							Ka ? moduleRtn = k : moduleRtn = new Promise((a, b) => {
								Aa = a;
								Ba = b;
							});
							return moduleRtn;
				...
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
						...
						*/
						AccessibilityOverlay.prototype.rebuildChildren = function(parentEl, childIds, tree, parentArtboardLeft, parentArtboardTop, activeIds, applyAllAttributes) {
							for (var i = 0; i < childIds.length; i++) {
								...
								if (currentChild !== el) {
									if (currentChild) parentEl.insertBefore(el, currentChild);
						...
						*/
						...
						AccessibilityOverlay.prototype.applyAttributes = function(el, node) {
							...
							if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasTrait)(traits, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticTrait.Checkable) && ARIA_CHECKED_ROLES.has(role)) {
								if ((0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Mixed) && role !== _types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.switchControl) setAttr(el, "aria-checked", "mixed");
								else setBoolAttr(el, "aria-checked", (0, _types__WEBPACK_IMPORTED_MODULE_0__.hasState)(flags, _types__WEBPACK_IMPORTED_MODULE_0__.SemanticState.Checked));
					...
					*/
					var ARIA_SELECTED_ROLES = /* @__PURE__ */ new Set([_types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.tab]);
					...
					*/
					var ARIA_PRESSED_ROLES = /* @__PURE__ */ new Set([_types__WEBPACK_IMPORTED_MODULE_0__.SemanticRole.button]);
				...
				((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
					...
					var CustomFileAssetLoaderWrapper = function() {
						...
						CustomFileAssetLoaderWrapper.prototype.loadContents = function(asset, bytes) {
							var assetWrapper;
							if (asset.isImage) assetWrapper = new ImageAssetWrapper(asset);
							else if (asset.isAudio) assetWrapper = new AudioAssetWrapper(asset);
							else if (asset.isFont) assetWrapper = new FontAssetWrapper(asset);
							else return false;
					...
					*/
					Animator.prototype.atLeastOne = function(playing, fireEvent, semanticsActive) {
						...
						if (this.animations.length === 0 && this.stateMachines.length === 0) {
							if (this.artboard.animationCount() > 0) this.add([instancedName = this.artboard.animationByIndex(0).name], playing, fireEvent);
				...
				*/
				...
				var RiveFile = function() {
					...
					RiveFile.prototype.releaseFile = function() {
						var _a;
						if (this.selfUnref) (_a = this.file) === null || _a === void 0 || _a.unref();
						this.file = null;
					};
							...
							return __generator(this, function(_c) {
								switch (_c.label) {
									...
									case 5:
										...
										else this.fireLoadError(RiveFile.fileLoadErrorMessage);
										return [2];
								}
							});
						});
				...
				var Rive = function() {
					...
					*/
					Rive.prototype.cleanup = function() {
						...
						if (this.file) {
							(_c = this.riveFile) === null || _c === void 0 || _c.cleanup();
							this.file = null;
						}
						this.riveFile = null;
						...
						(_d = this._viewModelInstance) === null || _d === void 0 || _d.cleanup();
						this._viewModelInstance = null;
						this._globalViewModelInstances.forEach(function(instance) {
				...
				var ViewModelInstance = function() {
					...
					ViewModelInstance.prototype.viewModelFromPathSegments = function(pathSegments, index) {
						...
						if (viewModelInstance !== null) {
							if (index == pathSegments.length - 1) return viewModelInstance;
